...
//go:embed migration/0001_capture.sql
var schema string

// migrate applies the embedded schema once, re-checking the version inside the transaction so a concurrent first
// migration cannot apply the schema twice.
